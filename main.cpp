...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ( review_mix_with_earliest_option, boost::program_options::value<std::string>()->default_value( "false" ),  "mix with earliest" )
        ( review_mix_with_random_option, boost::program_options::value<std::string>()->default_value( "false" ),  "mix with radom" )
