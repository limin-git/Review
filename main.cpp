...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ( review_group_size_option, boost::program_options::value<size_t>()->default_value( 0 ),  "group size" )
        ( review_group_repeat_option, boost::program_options::value<size_t>()->default_value( 0 ),  "group repeat" )
        ( review_group_manually_add_option, boost::program_options::value<std::string>()->default_value( "false" ),  "whether manually add items to group" )
